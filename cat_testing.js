	...
	CategoryEditor.prototype = {
		...
		initialize : function (line, span, after, key, is_hidden) {
			...
			if (!span) {
				...
				this.linkSpan.className = 'noprint nopopups hotcatlink TEST';
        ...
        //GCTools added formtype
		makeForm : function (formtype) {
			var form = make ('form');
            ...
            //GCTools add a condition here to show either the textbox or the select inputs
            if(!formtype){
        ...
        //GCTools added ftype (form type) to test for audience dropdown
		display : function (evt, ftype) {
			...
			if (!this.form) {
                //GCTools pass form type to make form
				this.makeForm (ftype);
			}
        ...
        show_a : function(evt){
            //GCTools audience show form
            var ftype = 'audience';
            var result = this.display( evt, ftype);
            return result;
        },
        ...
        open_a : function (evt) {
            //GCTools open audience form
            return this.show_a(evt);
        },
		...
		accept : function (evt) {
			...
			if (this.acceptCheck ()) {
                ...
                console.log('failed acceptCheck');
            }
			return result;
		},
